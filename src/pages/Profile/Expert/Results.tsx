...
const Results: Component = () => {
  return (
    <DialogFacade
      ...
      triggerClassName='btn sidebar'
    >
      <p class='info'>
        The call stack is responsible for keeping track of all the operations in
        line to be executed. Whenever a function is finished, it is popped from
        the stack.
      </p>
      <p class='info'>
      ...
      <p class='info'>
        ...
        call stack, the API starts its own single-threaded operation. An example
        of this is the setTimeout method. When a setTimeout operation is
        processed in the stack, it is sent to the corresponding API which waits
